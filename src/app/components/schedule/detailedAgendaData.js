...
export const day1 = [
  ...
  { id: 'coffee', start: '3:32 PM', end: '3:45 PM', title: 'Coffee Break', description: 'Networking over coffee.' },
  { id: 'ws-web', start: '4:00 PM', end: '5:00 PM', title: 'Workshop Track 1: Web/Mobile Development', description: 'Full‑stack web & mobile UI development.' },
  { id: 'ws-cloud', start: '4:00 PM', end: '5:00 PM', title: 'Workshop Track 2: Cloud', description: 'Containerization & orchestration fundamentals.' },
  { id: 'ws-ai1', start: '4:00 PM', end: '5:30 PM', title: 'Workshop Track 3: AI (Part 1)', description: 'Foundational ML concepts & hands‑on model building.' },
  { id: 'ws-solid1', start: '4:00 PM', end: '5:30 PM', title: 'Workshop Track 4: Certified SolidWorks (Part 1)',  description: 'SolidWorks for beginners.' },
  { id: 'industry-network', start: '5:15 PM', end: '6:15 PM', title: 'Industry Booth Networking',  description: 'Facilitated industry networking & informal discussions.' },
  { id: 'cs-benefits', start: '6:15 PM', end: '7:00 PM', title: 'CS Benefits Session', description: 'Computer Society benefits overview.' },
  { id: 'student-yp', start: '6:15 PM', end: '7:00 PM', title: 'Student‑to‑YP Transition Session', description: 'Mentorship with IEEE YP members.' },
  { id: 'mtts', start: '6:15 PM', end: '7:00 PM', title: 'MTTS Session', description: 'MTTS technical session.' },
  { id: 'smc', start: '6:15 PM', end: '7:00 PM', title: 'SMC Session', description: 'Systems, Man & Cybernetics focused session.' },
  { id: 'ws-ai2', start: '6:15 PM', end: '7:45 PM', title: 'Workshop Track 3: AI (Part 2)', description: 'Continuation of AI workshop.' },
  { id: 'ws-solid2', start: '6:15 PM', end: '7:45 PM', title: 'Workshop Track 4: Certified SolidWorks (Part 2)',  description: 'Continuation of SolidWorks workshop.' },
  { id: 'dinner', start: '7:30 PM', end: '9:00 PM', title: 'Dinner', description: 'Buffet dinner & relaxed networking.' },
  { id: 'leadership', start: '9:15 PM', end: '10:15 PM', title: 'Leadership Bootcamp (Injaz Tunisia)', description: 'Entrepreneurial leadership & project management training.' },
  {
    id: 'hackathon-launch',
    start: '10:15 PM',
    end: '10:30 PM',
  ...
  { id: 'party', start: '11:00 PM', end: '1:00 AM', title: 'Hotel Party & Networking', description: 'Informal networking & community building.' }
];

export const day2 = [
  { id: 'breakfast', start: '7:00 AM', end: '9:00 AM', title: 'Breakfast',  description: 'Morning refreshments & networking.' },
  { id: 'ieee-mentoring', start: '9:30 AM', end: '10:30 AM', title: 'IEEE Mentoring',  description: 'Promoting mentoring program.' },
  {
    id: 'hackathon-finale',
    start: '10:30 AM',
    end: '12:00 PM',
  ...
  { id: 'lunch', start: '12:00 PM', end: '1:00 PM', title: 'Lunch with Industry Mentors', description: 'Informal career discussions.' },
  { id: 'checkout', start: '1:00 PM', end: '1:30 PM', title: 'Check‑out Process', description: 'Departure logistics before afternoon sessions.' },
  {
    id: 'awards',
    start: '1:30 PM',
    end: '2:00 PM',
